...
\begin{document}
    ...
    \item{Natural language processing, Large language models, Data-centric AI, Parameter-efficient Fine-tuning}
    \end{enumerate}
    ...
    \begin{itemize}[leftmargin=*,label=]
        ...
        {\textbf{B.S.} in \textbf{\href{http://bit.ly/3Uu4LTi}{Information and Communication Engineering}}}{March 2018 - Present}{\href{https://eng.inha.ac.kr/eng/index.do}{Inha University}}{Incheon, South Korea}
            \begin{itemize}[label=\bullet]
                ...
                \item{Relevant Coursework: \textit{AI Applications, Signal and Systems, Digital Image Processing, \\Data Structure, Algorithm Capstone Design, Database Capstone Design}}
            \end{itemize}
    \end{itemize}
