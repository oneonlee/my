...
\begin{document}
    ...
    \begin{itemize}[leftmargin=*,label=]
        \resumeSubheading
        {\textbf{\href{http://dilab.inha.ac.kr/}{Data Intelligence Laboratory}}, Inha University}{November 2022 - Present}
            {Research Assistant (Advisor: \underline{\href{http://bit.ly/3zSrQ8F}{Prof. Wonik Choi}})}{Incheon, South Korea}
        \resumeSubheading
        {\textbf{Nursing Informatics Laboratory}, Inha University}{August 2021 - Present}
            {Research Assistant (Advisor: \underline{\href{http://bit.ly/412nYOw}{Prof. Insook Cho}})}{Incheon, South Korea}
    \end{itemize}
