...
\begin{document}
    ...
    \item{Data-centric natural language processing, Domain adaptation for large language models (LLMs), Improvement of retrieval-augmented generation (RAG), Evaluation of LLMs \& RAG}
    \end{enumerate}
