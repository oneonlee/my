...
\begin{document}
    ...
    \begin{center} 
        ...
        % \\ Personal Website: \underline{\href{https://sites.google.com/view/dg-lee/}{https://sites.google.com/view/dg-lee/}}
        {
    ...
    \item{Natural language processing, Large language model, Data-centric AI, AI applications}
    \end{enumerate}
